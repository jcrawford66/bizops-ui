      ...
      <div className="px-4 pb-2 flex gap-2 overflow-x-auto scrollbar-thin">
        {['Last customer?', 'Revenue this month?', 'Low stock items?'].map(p => (
          <button
            ...
            className="text-xs bg-slate-100 hover:bg-brand-50 hover:text-brand-600 text-slate-600 px-3 py-1 rounded-full whitespace-nowrap transition-colors flex-shrink-0"
          >
            {p}
          </button>
        ))}
